# Example for Nuvoton NCT7717U thermal sensor on Nuvoton's Mbed CE enabled boards

This is an example to demo Nuvoton NCT7717U thermal sensor on Nuvoton's Mbed CE enabled boards.
...
1.  Clone the example and navigate into it
    ```
    $ git clone https://github.com/mbed-nuvoton/NuMaker-mbed-ce-I2C-NCT7717U-example
    $ cd NuMaker-mbed-ce-I2C-NCT7717U-example
...
Flash by drag-n-drop built image `NuMaker-mbed-ce-I2C-NCT7717U-example.bin` or `NuMaker-mbed-ce-I2C-NCT7717U-example.hex` onto **NuMaker-IoT-M467** board
...
```
NCT7717U demo program.
Chip ID is 50.
Vendor ID is 50.
Device ID is 91.
Curent Temperature is 29.
Curent Temperature is 29.
Curent Temperature is 29.
```
